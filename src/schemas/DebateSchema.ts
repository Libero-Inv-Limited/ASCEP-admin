...
export const startDebateSchema = z.object({
  ...
  description: z
    .string({ required_error: "Debate description is required" })
    .min(20, {
...
export const debateCommentSchema = z.object({
  ...
  debate_id: z.string({ required_error: "debate id is required" }),
...
export const voteDebateCommentSchema = z.object({
  ...
  comment_id: z.string({ required_error: "debate id is required" }),
});

...
interface DemocracyDownloadModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function DemocracyDownloadModal({
  isOpen,
  onClose,
}: DemocracyDownloadModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <h4 className="pb-3 border-b border-dark/10 ">Download</h4>
